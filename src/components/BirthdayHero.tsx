import bossPhoto from "@/assets/pak-toni.jpg";
import { Cake, Sparkles, Star } from "lucide-react";
import CelebrationButton from "./CellebrationButton";
          ...
          >
            <h1 className="text-6xl md:text-7xl font-bold text-primary-foreground leading-tight">
              ...
              <span className="block bg-gradient-to-r from-accent to-accent/80 bg-clip-text text-transparent">
                Ulang Tahun Pak Toni
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed">
              Di hari spesial ini semoga kalimat demi kalimat yang kami rangkai
              disini bisa menjadi hadiah kecil yang menyentuh hati pak toni.
              Mohon maaf kalau diperjalanan kita ini, Kami sering mengecewakan.
            </p>
          </div>
